...
hongcaiApp.controller('ProjectCategoryCtrl', ['$scope','$rootScope', '$location', function ($scope, $rootScope, $location) {
  ...
  $scope.projectCategory = [{'title':'理财项目',
    'content':'平台提供机构担保标、实地认证标等多类产品，用户根据审核后的信息，自选合适的借款标的，构建符合个人意愿的投资组合。',
    'tips':['项目收益率10% - 18%','期限灵活1-12个月','100元起投，可小额多笔投资，分散风险','100%本息保障'],
   ...
   {'title':'宏运当头标',
    ...
    'tips':['项目收益率10% - 90%','期限灵活3天','0元起投，每位用户最多使用10张宏包投资','到期返息，可投资，可取现'],
